...
const GenerateArticleOutputSchema = z.object({
  title: z
    .string()
    .describe('The title of the article. It must be exactly 10 words long.'),
  summary: z
    .string()
    .describe('A detailed and helpful summary of the article, approximately 30-40 words long. It should capture the main points and entice the user to read more.'),
  content: z
    .string()
    .describe(
      'The full, detailed, and helpful article content, in Markdown format. It must be exactly 1600 words.'
    ),
...
1.  **Title:** The title MUST be exactly 10 words long. It should be clear, user-friendly, and focused on the topic.
2.  **Summary:** The summary MUST be detailed and helpful, approximately 30-40 words long.
3.  **Word Count:** The body of the article MUST be exactly 1600 words long.
