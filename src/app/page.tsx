...
const faqItems = [
  ...
  },
  {
    ...
    answer: "This site uses a 'generate-on-demand' strategy. When a user visits an article for the first time, its content and image are generated by AI. This content is then cached in a file on the server, making the site very fast for all subsequent visits.",
  },
  {
    question: "Do I need any API keys to run this site?",
