...
const GenerateArticleOutputSchema = z.object({
  ...
  content: z
    .string()
    .describe(
      'The full, detailed, and helpful article content, in Markdown format. It must be at least 1500 words and MUST conclude with a "## 6 Key Takeaways" section.'
    ),
...
5.  **Structure & Formatting:** The response MUST be in well-structured Markdown format. It must follow this exact order:
    ...
    -   **6 KEY TAKEAWAYS (MANDATORY):** At the absolute end of the content, you MUST include a section titled "## 6 Key Takeaways". This section MUST contain a bulleted list of exactly six of the most important, actionable points from the article. This is a non-negotiable requirement for every article.

**CRITICAL RULE:** The 'content' field you generate MUST NOT start with an H1 heading (e.g., "# Title"). The article's title is handled by the separate 'title' field you will also generate. The content should begin directly with the first paragraph of the introduction. DO NOT REPEAT THE TITLE IN THE CONTENT.
