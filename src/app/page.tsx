...
const faqItems = [
  ...
  },
  {
    ...
    answer: "This site uses a 'generate-on-demand' strategy. When a user visits an article for the first time, its content is generated by an AI. This content is then cached in a database for 24 hours, making the site very fast for all subsequent visits.",
  },
  {
    question: "Do I need an API key to run this site?",
    answer: "Yes. For content generation to work, the website owner must provide their own API key for OpenRouter (for content) in a `.env` file. The site will show an error if it needs to generate articles and the key is missing.",
  },
  {
