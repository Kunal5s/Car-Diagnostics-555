...
const faqItems = [
    ...
    answer: "Car Diagnostics BrainAi is an intelligent platform that provides in-depth articles on automotive topics. It uses AI to generate fresh content to help you understand your vehicle better, with a smart caching system to keep the site fast.",
  },
  {
    question: "How does the content get generated?",
    answer: "This site uses a 'generate-on-demand' strategy. When a user visits an article for the first time, its content is generated by an AI and its image is fetched from Pexels. This content is then cached in a database for 24 hours, making the site very fast for all subsequent visits.",
  },
  {
    question: "Do I need API keys to run this site?",
    answer: "Yes. For content generation to work, the website owner must provide their own API keys for OpenRouter (for content) and Pexels (for images) in a `.env` file. The site will show an error if it needs to generate articles and the keys are missing.",
  },
  {
    question: "Why do I need to set up a Supabase database?",
    answer: "The Supabase database is essential for the site's performance and reliability. It acts as a cache, storing generated articles for 24 hours. This means an article is only generated once per day, making the site extremely fast for all other visitors and preventing timeouts. You must run the setup script in the README file.",
  },
  {
  ...
  {
    question: "How accurate are the AI-generated articles?",
