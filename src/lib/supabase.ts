...
// IMPORTANT: These details are public and safe to expose in client-side code.
// The security is handled by Row Level Security (RLS) policies in your Supabase project.
