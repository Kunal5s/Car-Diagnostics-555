...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn more about Car Diagnostics BrainAi, our mission, and our team of experts dedicated to helping you understand your vehicle better.',
};

export default function AboutPage() {
  return (
    <div className="container mx-auto max-w-4xl px-4 py-12">
      <h1 className="mb-6 text-4xl font-extrabold tracking-tight text-primary md:text-5xl">About Car Diagnostics BrainAi</h1>
      <div className="prose prose-lg dark:prose-invert max-w-none space-y-6">
        <p>
          Welcome to Car Diagnostics BrainAi, your intelligent partner in understanding and maintaining your vehicle. Our mission is to demystify car troubles and empower every car owner, from the novice driver to the seasoned DIY mechanic, with accurate, accessible, and easy-to-understand diagnostic information.
        </p>
        <p>
        ...
        <p>
          Thank you for trusting Car Diagnostics BrainAi. We're excited to be on this journey with you, helping you keep your car running smoothly and safely for years to come.
        </p>
      </div>
    </div>
  );
